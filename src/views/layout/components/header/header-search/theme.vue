...
<template>
  <div class="">
    <div class="text-xs mb-1 text-zinc-400">精选热门</div>
    <div class="flex h-[140px]" v-if="themeData.list.length">
      ...
      <div class="flex flex-wrap flex-1 max-w-[860px]">
        ...
        >
          ...
          <p
            class="absolute bottom-0 left-0 w-full h-full flex items-center px-1 rounded duration-300 backdrop-blur hover:backdrop-blur-none"
          >
            # {{ item.title }}
          </p>
        </div>
